...
const lake =
  "https://images.unsplash.com/photo-1470770841072-f978cf4d019e?w=800&q=85&fit=crop"
const mountain =
  "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600&q=85&fit=crop"
const coast =
  "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=600&q=85&fit=crop"
...
export const generatedExamples: GeneratedContent[] = [
  ...generativeWorkExamples,
  {
    ...
    creator: "Audio study | Sample state",
    cover: coast,
    playing: false,
    position: 42,
    duration: 186,
  ...
  },
  {
    ...
    arrival: "18:05 EDT",
    progress: 58,
    status: "Sample itinerary",
  },
  {
    type: "location",
    title: "A place to slow down",
    subtitle: "Lake and mountain study",
    image: lake,
  },
  {
    type: "weather",
    location: "Coastal outlook",
    temperature: 58,
    unit: "F",
    condition: "Clear",
    forecast: [
      { day: "Sat", temperature: 63 },
      { day: "Sun", temperature: 65 },
      { day: "Mon", temperature: 72 },
      { day: "Tue", temperature: 70 },
      { day: "Wed", temperature: 66 },
    ],
  },
  {
    type: "stories",
    ...
    items: [
      {
        id: "beautiful",
        title: "Interfaces for AI-native work",
        source: "Beautiful UI | Component collection",
        image: lake,
        href: "https://www.beautifului.dev",
      },
      {
        id: "beui",
        title: "Motion with a useful purpose",
        source: "beUI | Agent interfaces",
        image: coast,
        href: "https://beui.dev",
      },
      {
        id: "board",
        title: "A consistent control foundation",
        source: "Open-source controls",
        image: mountain,
        href: "https://github.com/BoardUI/boardui",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        text: "The comparison is ready, with the key findings and source links together.",
        time: "2:40 PM",
        unread: true,
      },
      {
        id: "design",
        sender: "Design agent",
        text: "Three directions for the next review use the same type and spacing scale.",
        time: "2:32 PM",
        unread: false,
        images: [
          { id: "a", src: lake, alt: "Lake study" },
          { id: "b", src: coast, alt: "Landscape study" },
          { id: "c", src: mountain, alt: "Mountain study" },
        ],
      },
      {
        id: "planning",
        sender: "Planning agent",
        text: "The next review starts tomorrow at 9:30.",
        time: "2:18 PM",
        unread: true,
      },
    ],
  },
  {
    type: "note",
    title: "Working note",
    body: "Make the next useful action easy to find.",
    status: "Draft | This session",
  },
  {
    type: "collection",
    title: "Quiet landscapes",
    description: "Visual references for the next project",
    images: [
      { id: "a", src: lake, alt: "Mountain lake" },
      { id: "b", src: coast, alt: "Open landscape" },
      { id: "c", src: mountain, alt: "Mountain peak" },
    ],
  },
  {
    type: "event",
    ...
    attendees: ["Alex Morgan", "Sam Lee", "Riley Chen"],
  },
  {
    type: "activity",
    ...
    value: "24",
    unit: "sources",
    description: "Reviewed over the last seven days",
    points: [
      { label: "M", value: 3 },
      { label: "T", value: 5 },
      { label: "W", value: 2 },
