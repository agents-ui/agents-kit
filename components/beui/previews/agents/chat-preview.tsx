...
const DEFAULT_MESSAGES: ChatPreviewMessage[] = [
  {
    id: "welcome-question",
    from: "user",
    content: "What should we include in the first field study?",
  },
  {
    id: "welcome-answer",
    from: "assistant",
...
const DEFAULT_REPLY =
  "I’d include wheelchair users, people traveling with luggage, and both peak and off-peak station visits."
    ...
    >
      ...
      <div className="border-border/60 shrink-0 border-t p-2">
        <PromptInput
          ...
          className="bg-muted border-0 shadow-none focus-within:border-transparent"
        />
      </div>
    </div>
  )
