...
function ReviewFlow() {
  ...
  return (
    <ApprovalCard
      title="Share the fieldwork synthesis?"
      description="The agent has prepared the synthesis and is waiting for your decision."
      status={status}
      ...
      result={
        status === "approved"
          ? "The synthesis was approved."
          : status === "changes-requested"
            ? "The agent will wait for revision notes."
            : "Sharing was declined."
      }
    >
      <dl className="grid gap-1 text-xs">
        <div className="flex items-center justify-between gap-4 py-1">
          <dt className="text-muted-foreground">Study</dt>
          <dd className="text-foreground/80 font-mono">jaipur-mobility</dd>
        </div>
        <div className="flex items-center justify-between gap-4 py-1">
          <dt className="text-muted-foreground">Checks</dt>
          <dd className="text-foreground/80">12 interviews linked</dd>
        </div>
        <div className="flex items-center justify-between gap-4 py-1">
          <dt className="text-muted-foreground">Visibility</dt>
          <dd className="text-foreground/80">Research team</dd>
        </div>
      </dl>
    </ApprovalCard>
  )
