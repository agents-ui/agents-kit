...
<ComponentCodePreview
  ...
  classNameComponentContainer="mx-auto min-w-0 w-full max-w-4xl p-4"
/>
...
<CodeBlock
  code={`npx shadcn@latest add "https://agents-ui.github.io/agents-kit/c/agent-task-queue.json"`}
  language="bash"
/>
